...
public class SuzukaController {
	...
	public SuzukaController(Driver userDriver, int circuitidx) throws InterruptedException, IOException {
	...
	public void playSuzuka(Driver driver) throws InterruptedException, IOException {
	    ...
	    if(suzuka.getCurrentWeather()==1) { // 비가 오면
...
//	    			System.out.println(d.getDriverName() + " 선수는 비 오는 날씨에 강한 선수입니다. +3점 가산점 부여!");/////////////////////디버깅 (정상작동)
	    ...
	    String txt2 = "[TEAM RADIO] : OK! "+userDriver.getDriverName()+" 일본 날씨가 좋네. 풀 포지션 따내보자.";
	    gc.printStringOnebyOne(txt2);
...
//		System.out.println(CircuitController.pc.driverListForGrandPix); /////// ///// ///// ///// ///// /// 디버깅
		...
		System.out.println(suzuka.getCircuitName()+" 그랑프리 플레이가 종료되었습니다.");
