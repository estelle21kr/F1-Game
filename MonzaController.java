...
//	    			System.out.println(d.getDriverName() + " 선수는 비 오는 날씨에 강한 선수입니다. +3점 가산점 부여!");/////////////////////디버깅 (정상작동)
	    ...
	    String txt2 = "[TEAM RADIO] : OK! "+userDriver.getDriverName()+" 몬자 서킷도 우승할 수 있어. 잘해보자.";
	    gc.printStringOnebyOne(txt2);
		...
		// 1번 코스 [Rettifilo]
		Course course1 = new Course(1, "Rettifilo", 1, 340); // 1 - 직선
		...
		sc.nextLine();
		cc.generateAICurrentSpeeds(userDriver, 330, 360);
		System.out.println();
		...
		// 2번 코스 [Lesmo]: 고속 우회전
		Course course2 = new Course(2, "Lesmo", 2, 170);
		...
		userDriver.setCurrentSpeed(sc.nextInt());
		sc.nextLine();
		cc.generateAICurrentSpeeds(userDriver, 150, 180);
		System.out.println();
...
//		sc.nextLine();
		...
		// 3번 코스 [Parabolica]
		Course course3 = new Course(3, "Parabolica", 2, 270);
		...
		userDriver.setCurrentSpeed(sc.nextInt());
		sc.nextLine();
		cc.generateAICurrentSpeeds(userDriver, 250, 280);
		System.out.println();
